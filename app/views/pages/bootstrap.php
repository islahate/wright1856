...
<div class="container">
    <section class="header">
        ...
        <ul class="nav d-flex flex-row justify-content-lg-center justify-content-md-start" style="width: 100%;">
            ...
            <?php if($_SESSION['langue'] == 'en'): ?>
                <li class="d-none d-lg-flex p-2 flex-row col-sm-10 menu_top">
                    ...
                    <div class="nav-item p-2 col d-flex align-items-center justify-content-center"><a class="nav-link <?= ($breadcrumbs[0] == 'accessories')? 'active':'' ?>" href="<?= SITE_WEB ?>accessories"><?= ucwords(strtolower(MENU_ACCESSOIRES)) ?></a></div>
            ...
            <?php else: ?>
                <li class="d-none d-lg-flex p-2 flex-row col-sm-10 menu_top">
                    ...
                    <div class="nav-item p-2 col d-flex align-items-center justify-content-center sub-collection"><a class="nav-link <?= ($breadcrumbs[0] == 'collections')? 'active':'' ?>" href="<?= SITE_WEB ?>collections"><?= ucwords(strtolower(MENU_COLLECTION)) ?></a></div>
                    <div class="nav-item p-2 col d-flex align-items-center justify-content-center"><a class="nav-link <?= ($breadcrumbs[0] == 'accessoires')? 'active':'' ?>" href="<?= SITE_WEB ?>accessoires"><?= ucwords(strtolower(MENU_ACCESSOIRES)) ?></a></div>
                    ...
                    <div class="nav-item p-2 col d-flex align-items-center justify-content-center"><a class="nav-link <?= ($breadcrumbs[0] == 'nos-chambres')? 'active':'' ?>" href="<?= SITE_WEB ?>nos-magasins"><?= ucwords(strtolower(MENU_OUR_ROOM)) ?></a></div>
            ...
            <div class="row" style=" padding: 45px 0;">
                <div class="col">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="info col-10">
                            ...
                            <p><img src="<?= WEBROOT ?>img/phone_icon.png" alt="" style="margin-right: 10px;" /><?= refaireTel($params['ETS_TEL']) ?></p>
                ...
                <div class="col newsletter">
                    ...
                    <form style="display: flex;">
                        <input type="text" class="input2" placeholder="Type your email" style="width: 69%;">
                        <button class="btn-principal" style="height: 56px; width: 30%;">Sign In</button>
                    </form>
                </div>
    ...
    $(document).ready(function () {
        ...
        $('#mutant').click(function () {
            ...
            if ($(this).hasClass('active')) {
                ...
                // $('.menu_top').fadeIn("slow", function() {
                //     $('.menu_top').attr("style", "display: -ms-flexbox !important; display: flex !important;");
                // });
            } else {
                $('.logo').animate({'left': ($('.header').width() / 2) - 66.5 + 'px', 'padding-left': 23}, 700); // padding-left: 0;

                $('.menu_top').fadeOut("slow", function () {
